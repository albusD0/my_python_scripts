# -*- coding: utf-8 -*-
import os, shutil, time, sys, datetime
today = datetime.datetime.now()
today = today.strftime("%H:%M - %d-%m-%Y")
print (today)
f_list = [today]
source_folder = r'C:\Users\TatToRus\Documents\Почта\Сегодняшнее\\'
destination_folder = r'C:\Users\TatToRus\Documents\Почта\Архив почты\\'
